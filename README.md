...
- controllers.py: registramos la ruema /awesome_owl para acceder a nuestro componente playground.
...
- En la vista llamamos a la varialbe con "t-esc" y al metodo con un evento "t-on-click"
...
- Luego importamos el compoenente en el playgournd en el atributo static components para utilizarlo en el xml del playground
